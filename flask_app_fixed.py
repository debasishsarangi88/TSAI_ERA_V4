...
def analyze_image_colors(image):
    ...
    # Define color ranges for different foods - IMPROVED THRESHOLDS
    color_ranges = {
...
def classify_food_by_features(image, color_analysis):
    ...
    # 9. Sandwich detection (moderate colors, moderate texture)
    ...
    if dominant_color[0] == 'red' and dominant_color[1] > 10:
        return 'pizza'
...
def analyze_image_with_ai(image_path):
    ...
    try:
        ...
        return {
            ...
            "ai_model": "YOLOv8 + Deterministic CV Pipeline",
