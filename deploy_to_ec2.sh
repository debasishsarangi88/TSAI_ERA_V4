...
echo "🚀 Deploying Updated YouTube Audio Waveform Visualizer to EC2"
echo "=============================================================="
echo ""
...
KEY_FILE="your-key-pair.pem"  # Replace with your actual key file path
...
echo "🔑 Key file found. Proceeding with deployment..."
echo ""
